            ...
            new Thread( () -> {
                ...
                try{
                    ...
                    while( ( rec = dis.readUTF() ) != null ){
                        ...
                        if( rec.equals( "standby" ) ){//接收到客户端1准备
                            this.standby1 = 1;
                        }
            ...
            new Thread( () -> {
                ...
                try{
                    ...
                    while( ( rec2 = dis2.readUTF() ) != null ){
                        text_r.append( "客户端2 " + sdf.format( new Date( System.currentTimeMillis() ) ) + "\n" );
                        text_r.append( rec2 + "\n\n" );
                        text_l.setText( "" );
                        text_r.setCaretPosition( text_r.getText().length() );


                        if( rec2.equals( "standby" ) ){//接收到客户端2准备
                            this.standby2 = 1;
                        }
                        if( standby1 == 1 && standby2 == 1 ){//客户端12都准备好
                            standby();
                        }
                        if( rec2.substring( 0, 1 ).equals( "C" ) ){ //接收到客户端2信息
