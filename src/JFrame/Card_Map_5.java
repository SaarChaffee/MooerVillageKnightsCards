...
public class Card_Map_5 extends javax.swing.JFrame {
    ...
    void updateIcon() {
        if( Golbal.Cards_isHave[41] ) ChangeImg.changeImg( jLabel1, 41 );
        else new ChangeImg().changeImgBlack( jLabel1, 41 );
        if( Golbal.Cards_isHave[42] ) ChangeImg.changeImg( jLabel2, 42 );
        else new ChangeImg().changeImgBlack( jLabel2, 42 );
        if( Golbal.Cards_isHave[43] ) ChangeImg.changeImg( jLabel3, 43 );
        else new ChangeImg().changeImgBlack( jLabel3, 43 );
        if( Golbal.Cards_isHave[44] ) ChangeImg.changeImg( jLabel4, 44 );
        else new ChangeImg().changeImgBlack( jLabel4, 44 );
        if( Golbal.Cards_isHave[45] ) ChangeImg.changeImg( jLabel5, 45 );
        else new ChangeImg().changeImgBlack( jLabel5, 45 );
        if( Golbal.Cards_isHave[46] ) ChangeImg.changeImg( jLabel6, 46 );
        else new ChangeImg().changeImgBlack( jLabel6, 46 );
        if( Golbal.Cards_isHave[47] ) ChangeImg.changeImg( jLabel7, 47 );
        else new ChangeImg().changeImgBlack( jLabel7, 47 );
        if( Golbal.Cards_isHave[48] ) ChangeImg.changeImg( jLabel8, 48 );
        else new ChangeImg().changeImgBlack( jLabel8, 48 );
        if( Golbal.Cards_isHave[49] ) ChangeImg.changeImg( jLabel9, 49 );
        else new ChangeImg().changeImgBlack( jLabel9, 49 );
        if( Golbal.Cards_isHave[50] ) ChangeImg.changeImg( jLabel10, 50 );
        else new ChangeImg().changeImgBlack( jLabel10, 50 );
    ...
    private void initComponents() {
        ...
        backGround.add( 水2, new org.netbeans.lib.awtextra.AbsoluteConstraints( 280, 330, -1, -1 ) );
        ...
        backGround.add( 水3, new org.netbeans.lib.awtextra.AbsoluteConstraints( 480, 330, -1, -1 ) );
        ...
        backGround.add( 水5, new org.netbeans.lib.awtextra.AbsoluteConstraints( 870, 330, -1, -1 ) );
        ...
        backGround.add( jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints( 630, 390, -1, -1 ) );
        ...
        backGround.add( 拥有卡牌, new org.netbeans.lib.awtextra.AbsoluteConstraints( 281, 13, 230, 41 ) );
        ...
        呢称.setText( "呢称" );
        backGround.add( 呢称, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 10, 160, -1 ) );

        等级.setFont( new java.awt.Font( "宋体", 1, 14 ) ); // NOI18N
        等级.setText( "等级" );
        backGround.add( 等级, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 50, 120, -1 ) );

        点券.setFont( new java.awt.Font( "宋体", 1, 14 ) ); // NOI18N
        点券.setText( "点券" );
        backGround.add( 点券, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 90, 390, -1 ) );
