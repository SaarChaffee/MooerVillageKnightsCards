...
public class Card_Map_2 extends javax.swing.JFrame {
    ...
    void updateIcon() {
        if( Golbal.Cards_isHave[11] ) ChangeImg.changeImg( jLabel1, 11 );
        else new ChangeImg().changeImgBlack( jLabel1, 11 );
        if( Golbal.Cards_isHave[12] ) ChangeImg.changeImg( jLabel2, 12 );
        else new ChangeImg().changeImgBlack( jLabel2, 12 );
        if( Golbal.Cards_isHave[13] ) ChangeImg.changeImg( jLabel3, 13 );
        else new ChangeImg().changeImgBlack( jLabel3, 13 );
        if( Golbal.Cards_isHave[14] ) ChangeImg.changeImg( jLabel4, 14 );
        else new ChangeImg().changeImgBlack( jLabel4, 14 );
        if( Golbal.Cards_isHave[15] ) ChangeImg.changeImg( jLabel5, 15 );
        else new ChangeImg().changeImgBlack( jLabel5, 15 );
        if( Golbal.Cards_isHave[16] ) ChangeImg.changeImg( jLabel6, 16 );
        else new ChangeImg().changeImgBlack( jLabel6, 16 );
        if( Golbal.Cards_isHave[17] ) ChangeImg.changeImg( jLabel7, 17 );
        else new ChangeImg().changeImgBlack( jLabel7, 17 );
        if( Golbal.Cards_isHave[18] ) ChangeImg.changeImg( jLabel8, 18 );
        else new ChangeImg().changeImgBlack( jLabel8, 18 );
        if( Golbal.Cards_isHave[19] ) ChangeImg.changeImg( jLabel9, 19 );
        else new ChangeImg().changeImgBlack( jLabel9, 19 );
        if( Golbal.Cards_isHave[20] ) ChangeImg.changeImg( jLabel10, 20 );
        else new ChangeImg().changeImgBlack( jLabel10, 20 );
    ...
    private void initComponents() {
        ...
        backGround.add( 水2, new org.netbeans.lib.awtextra.AbsoluteConstraints( 270, 330, -1, -1 ) );

        jLabel3.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints( 420, 130, -1, -1 ) );
        ...
        backGround.add( 水3, new org.netbeans.lib.awtextra.AbsoluteConstraints( 470, 330, -1, -1 ) );

        jLabel4.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints( 620, 130, -1, -1 ) );
        ...
        backGround.add( 水4, new org.netbeans.lib.awtextra.AbsoluteConstraints( 670, 330, -1, -1 ) );

        jLabel5.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints( 810, 130, -1, -1 ) );
        ...
        backGround.add( 水5, new org.netbeans.lib.awtextra.AbsoluteConstraints( 860, 330, -1, -1 ) );
        ...
        backGround.add( 水7, new org.netbeans.lib.awtextra.AbsoluteConstraints( 270, 590, -1, -1 ) );

        jLabel8.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints( 420, 390, -1, -1 ) );
        ...
        backGround.add( 水8, new org.netbeans.lib.awtextra.AbsoluteConstraints( 470, 590, -1, -1 ) );

        jLabel9.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints( 620, 390, -1, 200 ) );
        ...
        backGround.add( 水9, new org.netbeans.lib.awtextra.AbsoluteConstraints( 670, 590, -1, -1 ) );

        jLabel10.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints( 810, 390, -1, -1 ) );
        ...
        backGround.add( 水10, new org.netbeans.lib.awtextra.AbsoluteConstraints( 860, 590, -1, -1 ) );

        拥有卡牌.setFont( new java.awt.Font( "宋体", 1, 18 ) ); // NOI18N
        拥有卡牌.setText( "拥有卡牌数X/X" );
        backGround.add( 拥有卡牌, new org.netbeans.lib.awtextra.AbsoluteConstraints( 310, 20, 240, 50 ) );
        ...
        点券.setText( "点券" );
        backGround.add( 点券, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 90, 310, -1 ) );
