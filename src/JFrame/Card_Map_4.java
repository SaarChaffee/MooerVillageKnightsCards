...
public class Card_Map_4 extends javax.swing.JFrame {
    ...
    void updateIcon() {
        if( Golbal.Cards_isHave[31] ) ChangeImg.changeImg( jLabel1, 31 );
        else new ChangeImg().changeImgBlack( jLabel1, 31 );
        if( Golbal.Cards_isHave[32] ) ChangeImg.changeImg( jLabel2, 32 );
        else new ChangeImg().changeImgBlack( jLabel2, 32 );
        if( Golbal.Cards_isHave[33] ) ChangeImg.changeImg( jLabel3, 33 );
        else new ChangeImg().changeImgBlack( jLabel3, 33 );
        if( Golbal.Cards_isHave[34] ) ChangeImg.changeImg( jLabel4, 34 );
        else new ChangeImg().changeImgBlack( jLabel4, 34 );
        if( Golbal.Cards_isHave[35] ) ChangeImg.changeImg( jLabel5, 35 );
        else new ChangeImg().changeImgBlack( jLabel5, 35 );
        if( Golbal.Cards_isHave[36] ) ChangeImg.changeImg( jLabel6, 36 );
        else new ChangeImg().changeImgBlack( jLabel6, 36 );
        if( Golbal.Cards_isHave[37] ) ChangeImg.changeImg( jLabel7, 37 );
        else new ChangeImg().changeImgBlack( jLabel7, 37 );
        if( Golbal.Cards_isHave[38] ) ChangeImg.changeImg( jLabel8, 38 );
        else new ChangeImg().changeImgBlack( jLabel8, 38 );
        if( Golbal.Cards_isHave[39] ) ChangeImg.changeImg( jLabel9, 39 );
        else new ChangeImg().changeImgBlack( jLabel9, 39 );
        if( Golbal.Cards_isHave[40] ) ChangeImg.changeImg( jLabel10, 40 );
        else new ChangeImg().changeImgBlack( jLabel10, 40 );
    ...
    private void initComponents() {
        ...
        backGround.add( jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints( 240, 130, -1, -1 ) );
        ...
        backGround.add( 水2, new org.netbeans.lib.awtextra.AbsoluteConstraints( 290, 330, -1, -1 ) );

        jLabel3.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints( 440, 130, -1, -1 ) );
        ...
        backGround.add( 水3, new org.netbeans.lib.awtextra.AbsoluteConstraints( 490, 330, -1, -1 ) );

        jLabel4.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints( 640, 130, -1, -1 ) );
        ...
        backGround.add( 水4, new org.netbeans.lib.awtextra.AbsoluteConstraints( 690, 330, -1, -1 ) );
        ...
        backGround.add( 水5, new org.netbeans.lib.awtextra.AbsoluteConstraints( 876, 334, -1, -1 ) );
        ...
        backGround.add( 水6, new org.netbeans.lib.awtextra.AbsoluteConstraints( 80, 590, -1, -1 ) );

        jLabel7.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints( 240, 390, -1, -1 ) );
        ...
        backGround.add( 水7, new org.netbeans.lib.awtextra.AbsoluteConstraints( 290, 590, -1, -1 ) );

        jLabel8.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/Img_small/1.jpg" ) ) ); // NOI18N
        backGround.add( jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints( 440, 390, -1, -1 ) );
        ...
        backGround.add( 水8, new org.netbeans.lib.awtextra.AbsoluteConstraints( 490, 590, -1, -1 ) );
        ...
        backGround.add( 水10, new org.netbeans.lib.awtextra.AbsoluteConstraints( 883, 591, -1, -1 ) );
        ...
        backGround.add( 头像, new org.netbeans.lib.awtextra.AbsoluteConstraints( 191, 645, 171, 45 ) );
        ...
        backGround.add( 下一页, new org.netbeans.lib.awtextra.AbsoluteConstraints( 777, 642, 171, 45 ) );

        信息1.setFont( new java.awt.Font( "宋体", 0, 18 ) ); // NOI18N
        信息1.setIcon( new javax.swing.ImageIcon( getClass().getResource( "/icon/i1.gif" ) ) ); // NOI18N
        backGround.add( 信息1, new org.netbeans.lib.awtextra.AbsoluteConstraints( 34, 10, 100, 100 ) );

        呢称.setFont( new java.awt.Font( "宋体", 1, 14 ) ); // NOI18N
        呢称.setText( "呢称" );
        backGround.add( 呢称, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 10, 180, -1 ) );

        等级.setFont( new java.awt.Font( "宋体", 1, 14 ) ); // NOI18N
        等级.setText( "等级" );
        backGround.add( 等级, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 50, 80, -1 ) );

        点券.setFont( new java.awt.Font( "宋体", 1, 14 ) ); // NOI18N
        点券.setText( "点券" );
        backGround.add( 点券, new org.netbeans.lib.awtextra.AbsoluteConstraints( 150, 90, 230, -1 ) );
    ...
    private void 头像ActionPerformed( java.awt.event.ActionEvent evt ) {//GEN-FIRST:event_头像ActionPerformed
        // TODO add your handling code here:
        this.setVisible( false );
        new Card_Map_3().setVisible( true );
    }//GEN-LAST:event_头像ActionPerformed
    ...
    private javax.swing.JButton 头像;
