...
public class Recharge extends JFrame {
    ...
    private void initComponents() {
        ...
        CDK输入区.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CDK输入区ActionPerformed(evt);
            }
        });
...
//            util.recharge( uid, cdk );
    ...
    private void CDK输入区ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CDK输入区ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CDK输入区ActionPerformed
